...
public class JDialog_AddCompAcc extends javax.swing.JDialog
{
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
	   ...
	   Party party = new Company(parentframe.clientName, parentframe.street,  parentframe.city,  parentframe.state,  parentframe.zip, JTextField_EM.getText(), 0); //TODO: JTextField_NoOfEmp.getText()  convert to integer
       Account account = null;
       if (JRadioButton_Chk.isSelected()){
           parentframe.accountType="Ch";
           account = new Checking(parentframe.accountnr, 0, party, 0);
       }
        else{
           parentframe.accountType="S";
           account = new Saving(parentframe.accountnr, 0, party, 0);
        }
	   
       //here call the service layer to save
       AccountService accountService = AccountServiceImp.getInstance();       
       if (accountService.createAccount(account))  //update the UI if the save success   
    	   parentframe.newaccount=true;//this line adds row to the UI
